...
public class LibraryMethods {
    ...
    public Optional<Book> searchBookByTitle(String title){
       ...
       if(optionalBook.isPresent()){
           ...
           System.out.printf(String.format("%-20s%-30s%-20s%-20s\n", optionalBook.get().getIsbn(), optionalBook.get().getTitle(), optionalBook.get().getCategory(), optionalBook.get().getQuantity()));
       }
       else {
    ...
    public List<Book> listAllBooks() {
        ...
        if (bookList.isEmpty()) {
            ...
            for (Book book : bookList) {
                ...
                System.out.println(String.format("%-20s%-30s%-20s%-20s%-20s%-20s\n", book.getIsbn(), book.getTitle(), book.getCategory(), book.getQuantity(), author.getName(), author.getEmail()));
            }
        }
        return bookList;
    }
